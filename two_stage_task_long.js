...
let images = [
    ...
    "img/treasure_1.png","img/patterns_3.png",
    "img/patterns_4.png","img/patterns_5.png","img/patterns_6.png","img/patterns_3_chosen.png",
    "img/patterns_4_chosen.png","img/patterns_5_chosen.png","img/patterns_6_chosen.png",
...
let stage2patterns = [
    [
        "img/patterns_3.png",
        "img/patterns_4.png",
        "img/patterns_3_chosen.png",
        "img/patterns_4_chosen.png",
    ],
    [
        "img/patterns_5.png",
        "img/patterns_6.png",
        "img/patterns_5_chosen.png",
        "img/patterns_6_chosen.png",
    ]
]
...
const show_reward = "<p class='center_position'><img src='img/treasure_1.png'/></p>";
const show_punish = "<p class='center_position'><img src='img/nonreward.png'/></p>";
...
const save_data = {
    ...
    filename: function() {
        filename = `${participantID}_long.csv`;
        return(filename);
    },
